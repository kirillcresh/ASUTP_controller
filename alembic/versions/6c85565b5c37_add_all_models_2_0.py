...
def upgrade() -> None:
    ...
    sa.Column('value', sa.Numeric(precision=10, scale=2), nullable=False, comment='Значение показателя'),
    sa.Column('update_time', sa.DateTime(), nullable=False, comment='Дата обновления записи'),
    ...
    sa.Column('date_created', sa.DateTime(), nullable=False, comment='Дата получения сообщения об ошибке'),
    sa.ForeignKeyConstraint(['closed_by'], ['user.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    comment='This table stores errors data'
    )
    op.create_table('history_register',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('param_id', sa.Integer(), nullable=False),
    sa.Column('element_id', sa.Integer(), nullable=False),
    sa.Column('value', sa.Numeric(precision=10, scale=2), nullable=False, comment='Значение показателя'),
    sa.Column('date_created', sa.DateTime(), nullable=False, comment='Дата создания записи'),
    sa.ForeignKeyConstraint(['element_id'], ['element.id'], ),
    sa.ForeignKeyConstraint(['param_id'], ['param.id'], ),
    sa.PrimaryKeyConstraint('id'),
    comment='This table stores history register data'
    )
    op.create_table('maintenance_journal',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('action_id', sa.Integer(), nullable=False),
    sa.Column('created_by', sa.Integer(), nullable=False),
    sa.Column('description', sa.Text(), nullable=False, comment='Описание действия'),
    sa.Column('value', sa.Numeric(precision=10, scale=2), nullable=True, comment='Значение показателя, если валидно'),
    sa.Column('date_created', sa.DateTime(), nullable=False, comment='Дата создания записи'),
    ...
    sa.Column('date_created', sa.DateTime(), nullable=False, comment='Дата создания отчета'),
    sa.ForeignKeyConstraint(['created_by'], ['user.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    comment='This table stores reports data'
    )
    op.create_table('state_register',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('param_id', sa.Integer(), nullable=False),
    sa.Column('element_id', sa.Integer(), nullable=False),
    sa.Column('value', sa.Numeric(precision=10, scale=2), nullable=False, comment='Значение показателя'),
